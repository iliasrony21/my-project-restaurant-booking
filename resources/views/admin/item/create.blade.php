           ...
           <form action="{{ route('item.store') }}" method="POST">
                ...
                <div class="col-lg-6 col-sm-6">
                    <div class="form-group">
                        <div class="form-control-wrap">
                            <input type="text" class="form-control form-control-xl form-control-outlined" name="name" >
                    ...
                    <div class="form-group">
                        <div class="form-control-wrap ">
                            <div class="form-control-select">
                                <select class="form-control form-control-xl" id="default-06" name="category">
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-6 col-sm-6">
                    <div class="form-group">
                        <div class="form-control-wrap">
                            <input type="text" class="form-control form-control-xl form-control-outlined" id="outlined-normal" name="price" >
                ...
                <div class="col-lg-6 col-sm-6">
                    <div class="form-group">
                        <div class="form-control-wrap ">
                            <textarea name="details" class="form-control form-control-xl" placeholder="Item Details"></textarea>
